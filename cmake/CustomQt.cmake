message(STATUS "include CustomQt.cmake")

# must use macro
macro(Custom_QtInit)
  message(STATUS "----------")
  cmake_parse_arguments("ARG" "" "" "COMPONENTS" ${ARGN})
  Custom_List_Print(TITLE "Qt Components" PREFIX "  - " STRS ${ARG_COMPONENTS})
  find_package(Qt5 COMPONENTS REQUIRED ${ARG_COMPONENTS})
  set(CMAKE_INCLUDE_CURRENT_DIR ON)
  if(WIN32)
    Custom_Path_Back(_QtRoot ${Qt5_DIR} 3)
...
function(Custom_QtBegin)
  set(CMAKE_AUTOMOC ON PARENT_SCOPE)
  set(CMAKE_AUTOUIC ON PARENT_SCOPE)
  set(CMAKE_AUTORCC ON PARENT_SCOPE)
endfunction()

function(Custom_QtEnd)
