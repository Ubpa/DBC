...
namespace rdo_bc
{
	...
	public:
		...
		bool init(const bc7e_utils::image_u8& src_image, rdo_bc_params& params);
		bool encode();

		const rdo_bc_params &get_params() const { return m_params; }

		const bc7e_utils::image_u8* get_orig_source_image() const { return m_pOrig_source_image; }
		const bc7e_utils::image_u8& get_source_image() const { return m_source_image; }
		...
		bool unpack_blocks(bc7e_utils::image_u8& unpacked_image) const;
	...
	private:
		const bc7e_utils::image_u8* m_pOrig_source_image;
		bc7e_utils::image_u8 m_source_image;
		...
		bc7e_utils::block8_vec m_packed_image8;
		bc7e_utils::block16_vec m_packed_image16;

		bc7e_utils::block8_vec m_prerdo_packed_image8;
		bc7e_utils::block16_vec m_prerdo_packed_image16;
